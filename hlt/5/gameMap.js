  ...
  */
  class GameMap {
    ...
    */
    ...
    isOccupied2(source) {
      if(this.get(source.position).isOccupied ||
      this.get(source.position.directionalOffset(Direction.getAllCardinals()[0])).isOccupied ||
      this.get(source.position.directionalOffset(Direction.getAllCardinals()[1])).isOccupied ||
      this.get(source.position.directionalOffset(Direction.getAllCardinals()[2])).isOccupied ||
      this.get(source.position.directionalOffset(Direction.getAllCardinals()[3])).isOccupied){
        return true;
      }
      return false;
    }
      ...
      */
      ...
      proSearch(source,n,flag){
        ...
        for(let i in mx){
          ...
          if(!this.get(source.position.directionalOffset(Direction.getAllCardinals()[ans])).isOccupied){
            return ans;
          }
          mx.splice(ans,1,0);
        }
